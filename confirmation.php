...
<head>
    ...
    <title>Sanaa Art Shop | Confirmation</title>
        ...
        <div class="row align-items-center justify-content-center">
            <div class="col-lg-12">
                <nav class="navbar navbar-expand-lg navbar-light">
                    <a class="navbar-brand" href="index.php"> <img src="img/S.logo.png" alt="logo"> </a>
                ...
                <div class="col-lg-8">
                    <div class="footer_menu">
                        <div class="footer_logo">
                            <a href="index.php"><img src="img/S.logo.png" alt="#"></a>
                        </div>
