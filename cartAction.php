...
if(isset($_REQUEST['action']) && !empty($_REQUEST['action'])){ 
    if($_REQUEST['action'] == 'addToCart' && !empty($_REQUEST['id'])){ 
        ...
        $sqlQ = "SELECT * FROM gallery WHERE id=?"; 
        ...
        $redirectURL = $insertItem?'cart.php':'cart.php'; 
        ...
        if(empty($errorMsg)){ 
            ...
            $stmt = $db->prepare($sqlQ); 
            $stmt->bind_param("sssss", $db_first_name, $db_last_name, $db_email); 
