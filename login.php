            ...
            <div class="col-lg-6 col-md-6">
                <div class="login_part_text text-center">
                    <div class="login_part_text_iner">
                        ...
                        <p>Looking to buy an artifact for your office, home, or as a gift?
            ...
            <div class="col-lg-6 col-md-6">
                <div class="login_part_form">
                    <div class="login_part_form_iner">
                        ...
                        <form class="row contact_form" action="index.php" method="post" novalidate="novalidate">
...
$login_qry = "SELECT * FROM user where email='$email' AND password='$password'";
